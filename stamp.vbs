...
Sub SendMail  
        objEmail.From = "986256128@qq.com" '发件人  
        objEmail.To = "1435059149@qq.com" '收件人  
        objEmail.Subject = "测试" '电子邮件主题主题  
        objEmail.Textbody = "测试内容请勿拒收123123" '电子邮件内容  
        ...
        objEmail.Configuration.Fields.Item _  
            ("http://schemas.microsoft.com/cdo/configuration/sendusername") = "986256128@qq.com" '用户名  
        objEmail.Configuration.Fields.Item _  
            ("http://schemas.microsoft.com/cdo/configuration/sendpassword") = "knqhkqrxygwjbaig" '密码  
        objEmail.Configuration.Fields.Item _  
